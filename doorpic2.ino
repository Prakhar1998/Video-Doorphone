...
// #define DEBUG                              -- commented out this line --
...
//0x8357  HX8357D LCD driver
  ...
  tft.setTextSize(2);
  tft.fillScreen(0);
  tft.setRotation(2);                            // -- changed rotation from 1 to 2 --
  // tft.println(F("Initializing SD card..."));     -- commented out this line --
  #if defined __AVR_ATmega2560__
...
//  bmpDraw("Test.bmp", 0, 0);                 -- commented out this line --

}

void loop()
{ bmpDraw("webcam.bmp", 12, 0);              // -- added my picture to draw here, centered --
/*  delay(2000);                                -- removed...
...
//#define BUFFPIXEL 20                        // -- uncommented the BUFFPIXEL line here --

void bmpDraw(char *filename, int x, int y) {
  #define BUFFPIXEL 60                        // -- put the line down here, increased buffer to 60 for faster loading --
  File     bmpFile;
